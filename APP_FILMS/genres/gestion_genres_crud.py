...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            valeur_update_dictionnaire = {"value_id_user": id_user_update, "value_name_genre": nom_user_update,"value_email": email_update,"value_password": mot_de_passe_update}
            print("valeur_update_dictionnaire ", valeur_update_dictionnaire)

            str_sql_update_intitulegenre = """UPDATE t_user SET nom_user = %(value_name_genre)s WHERE id_user = %(value_id_user)s"""
            with MaBaseDeDonnee() as mconn_bd:
...
"""
    ...
    Remarque :  Dans le champ "nom_user_delete_wtf" du formulaire "genres/genre_delete_wtf.html",
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_destinataire, t_attente, t_motif, t_payement, t_rappel WHERE fk_user = %(value_id_user)s"""
